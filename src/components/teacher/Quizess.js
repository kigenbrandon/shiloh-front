...
const Quizzes = () => {
    ...
    useEffect(() => {
        const handleTokenRefresh = async () => {
            try {
                ...
                if (refreshToken) {
                    const response = await axios.post('https://shiloh-server-2t51.onrender.com/users/refresh', { token: refreshToken });
    ...
    useEffect(() => {
        const fetchQuizzes = async () => {
            try {
                const response = await axios.get('https://shiloh-server-2t51.onrender.com/quizzes', {
    ...
    const refreshToken = async () => {
        try {
            ...
            const response = await axios.post('https://shiloh-server-2t51.onrender.com/users/refresh', {}, {
                headers: {
    ...
    const createQuiz = async (quiz) => {
        try {
            const response = await axios.post('https://shiloh-server-2t51.onrender.com/quizzes', quiz, {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const updateQuiz = async (quiz) => {
        try {
            const response = await axios.put(`https://shiloh-server-2t51.onrender.com/quizzes/${quiz.id}`, quiz, {
                headers: { Authorization: `Bearer ${token}` }
            });
            return response.data;
        } catch (error) {
